...
do
echo $site
wget  -qO- --no-check-certificate "https://aeronet.gsfc.nasa.gov/cgi-bin/print_web_data_v3?site="$site"&year="$year"&month=1&day=1&year2="$year2"&month2="$month2"&day2="$day2"&LWN"$level"=1&AVG=10" | sed -e 's/<[^>]*>//g' > ../OCv3/$site"_OCv3".lev$level
